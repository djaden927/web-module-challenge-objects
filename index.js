...
*/
console.log(createMenuItem("Pizza 2", "5", "lunch"))
console.log(createMenuItem("Pizza 3", "5", "lunch"))
console.log(createMenuItem("Pizza 4", "5", "lunch"))
...
*/
reviews.push({name: "Jaden", rating: 5, feedback: "I love Lambda!"});
console.log(reviews);
